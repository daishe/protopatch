...
func TestMove(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:            &protopatchv1.TestMessage{String_: "bbb", Message: &protopatchv1.TestMessage{String_: ""}},
		},

		{
			...
			want:            &protopatchv1.TestMessage{List: &protopatchv1.TestList{String_: []string{"bbb"}}, Message: &protopatchv1.TestMessage{List: &protopatchv1.TestList{String_: []string{}}}},
		},
		{
...

		{
			...
			want:            &protopatchv1.TestMessage{Map: &protopatchv1.TestMap{StringToString: map[string]string{"key": "bbb"}}, Message: &protopatchv1.TestMessage{Map: &protopatchv1.TestMap{StringToString: map[string]string{}}}},
		},
		{
			...
			want:            &protopatchv1.TestMap{StringToString: map[string]string{"key0": "bbb"}},
		},
...

		{
			...
			want:            &protopatchv1.TestMessage{List: &protopatchv1.TestList{Message: []*protopatchv1.TestMessage{{String_: "bbb"}}}, Message: &protopatchv1.TestMessage{List: &protopatchv1.TestList{Message: []*protopatchv1.TestMessage{}}}},
		},
		{
...

		{
			...
			want:            &protopatchv1.TestMessage{Map: &protopatchv1.TestMap{StringToMessage: map[string]*protopatchv1.TestMessage{"key": {String_: "bbb"}}}, Message: &protopatchv1.TestMessage{Map: &protopatchv1.TestMap{StringToMessage: map[string]*protopatchv1.TestMessage{}}}},
		},
		{
			...
			want:            &protopatchv1.TestMap{StringToMessage: map[string]*protopatchv1.TestMessage{"key0": {String_: "bbb"}}},
		},
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := protopatch.Move(base, test.targetPath, test.replacementPath, test.opts...)
			...
			patchtest.RequireEqual(t, test.want, base, "move value mismatch")
		})
	}
}
